...
function buildInstallerBat({ serverUrl, key, exeUrl }) {
  ...
  const lines = [
    '@echo off',
    'setlocal',
    'rem ===== Techlogic Productivity System - agent installer (per company) =====',
    ...
    '',
    'echo Installing the Techlogic Productivity agent...',
    ...
    '',
    'echo.',
    'echo Done. The agent is running now and will start automatically at login.',
